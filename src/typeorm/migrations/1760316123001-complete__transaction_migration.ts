...
export class Complete_Transaction_Migration1760316123001 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        console.log(`Found ${transactionCount[0]?.count || 0} transactions in transaction table`);
        ...
        console.log('✅ Completed migration of remaining transactions to payments table');
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        console.log('⚠️  Rollback of transaction migration is not fully reversible');
